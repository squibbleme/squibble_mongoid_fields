...
#
# [...]
# include Squibble::DateTimeValidity
# [...]
#
module Squibble::DateTimeValidity
  ...
  included do
    ...
    def _handle_error(error_key, from, till)
      ...
      translate_error_key = ['concerns.models.squibble.date_time_validity.period_validation.base', error_key].join('.')
